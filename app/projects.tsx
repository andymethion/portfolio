    ...
    <section className="flex justify-center py-8" id="projects">
      <div className="flex w-11/12 flex-col gap-8 sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-6/12 2xl:w-5/12">
        ...
        <div className="flex flex-col items-center gap-4">
          <a className="w-full" href="https://github.com/d60/twikit">
            <img className="h-64 w-full rounded-md object-cover" draggable="false" src="twitter.jpg" />
          </a>
          <a className="text-2xl font-bold" href="https://github.com/d60/twikit">Twitter</a>
        ...
        <div className="flex flex-col items-center gap-4">
          <a className="w-full" href="https://www.theshitbot.com/">
            <img className="h-64 w-full rounded-md object-cover" draggable="false" src="the-shit-bot.jpg" />
          </a>
          <a className="text-2xl font-bold" href="https://www.theshitbot.com/">The Shit Bot</a>
        ...
        <div className="flex flex-col items-center gap-4">
          <a className="w-full" href="https://github.com/andymethion/listener-rs">
            <img className="h-64 w-full rounded-md object-cover" draggable="false" src="blockchain.webp" />
          </a>
          <a className="text-2xl font-bold" href="https://github.com/andymethion/listener-rs">Blockchain</a>
        ...
        <div className="flex flex-col items-center gap-4">
          <a className="w-full" href="https://github.com/andymethion/quadtree">
            <img className="h-64 w-full rounded-md object-cover" draggable="false" src="quadtree.png" />
          </a>
          <a className="text-2xl font-bold" href="https://github.com/andymethion/quadtree">Quadtree</a>
