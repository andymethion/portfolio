    ...
    <section className="flex justify-center py-8" id="projects">
      <div className="flex w-11/12 flex-col gap-8 sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-6/12 2xl:w-5/12">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a className="text-2xl font-bold" href="https://github.com/d60/twikit" target="_blank">Twitter</a>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a className="text-2xl font-bold" href="https://www.theshitbot.com/" target="_blank">The Shit Bot</a>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a className="text-2xl font-bold" href="https://github.com/andymethion/listener-rs" target="_blank">Blockchain</a>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a className="text-2xl font-bold" href="https://github.com/andymethion/quadtree" target="_blank">Quadtree</a>
