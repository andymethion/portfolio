...
export default function Contact() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    toast("Contact email has been sent");
    console.log(values);
  }
    ...
    <section className="flex justify-center pt-8 pb-16" id="contact">
      <div className="flex w-11/12 flex-col gap-8 sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-6/12 2xl:w-5/12">
        ...
        <div className="flex gap-4">
          <a className="flex-1" href="mailto:andymethion@gmail.com" target="_blank">
          ...
          <a className="flex-1" href="https://www.linkedin.com/in/andy-methion-481224303/" target="_blank">
            <Button className="w-full cursor-pointer" variant="secondary">
          ...
          <a className="flex-1" href="https://github.com/andymethion/" target="_blank">
            <Button className="w-full cursor-pointer" variant="secondary">
              <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
