    ...
    <section className="flex justify-center pt-8 pb-16" id="contact">
      <div className="flex w-11/12 flex-col gap-8 sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-6/12 2xl:w-5/12">
        ...
        <div className="flex gap-4">
          <a className="flex-1 cursor-pointer" href="mailto:andymethion@gmail.com">
          ...
          <a className="flex-1 cursor-pointer" href="">
            <Button className="w-full" variant="secondary">
          ...
          <a className="flex-1 cursor-pointer" href="https://github.com/andymethion/">
            <Button className="w-full" variant="secondary">
